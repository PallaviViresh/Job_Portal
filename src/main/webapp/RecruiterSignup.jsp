...
<body>
	...
	<div class="container">
		<h3>${pos}</h3>
		<h2>${neg}</h2>
		<x:form action="/recruiter/signup" method="post"
			...
			<fieldset>
				...
				<table>
					...
					<tr>
					<th>Company Name:</th>
						<th><x:input type="text" path="companyname" /></th>
						<th><div class="error-message">
								<x:errors path="companyname" />
							</div></th>
					</tr>
					<tr>
					<th>Company Location:</th>
						<th><x:input type="text" path="companylocation" /></th>
						<th><div class="error-message">
								<x:errors path="companylocation" />
							</div></th>
							</tr>
							<tr>
		...
		<div class="back-button">
			<a href="/recruiter"><button>Back</button></a>
		</div>
	</div>
	<script>
