			...
			<fieldset>
				...
				<table>
					...
					<th>Highest Degree:</th>
						<th><x:input type="text" path="highestdegree" /></th>
						<th><div class="error-message">
								<x:errors path="highestdegree" />
							</div></th>
					</tr>
					<tr>
					<th>% Throughout:</th>
						<th><x:input type="text" path="percentage" /></th>
						<th><div class="error-message">
								<x:errors path="percentage" />
							</div></th>
							</tr>
							<tr>
							<th>Resume:</th>
						<th><x:input type="file" path="doc" /></th>
						<th><div class="error-message">
								<x:errors path="doc" />
							</div></th>
